...
#define SYSTEM_LINK_ID_ALGVEHICLE_0             DSP_LINK(SYSTEM_LINK_COMMON_LINKS_MAX_ID+5)
#define SYSTEM_LINK_ID_ALGVEHICLE_COUNT     (1)
...
#define SYSTEM_HOST_LINK_ID_IPC_COMMUNICATION		HOST_LINK(SYSTEM_LINK_COMMON_LINKS_MAX_ID+6)
