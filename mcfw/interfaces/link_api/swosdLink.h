...
#define SWOSDLINK_SETBMP_DATETIME_AUX	(0x800c)
#define SWOSDLINK_SETBMP_DATETIME_THIRD	(0x800d)

#define SWOSDLINK_SETBMP_USERTEXT		(0x800e)
#define SWOSDLINK_SETBMP_USERTEXT_AUX	(0x800f)
#define SWOSDLINK_SETBMP_USERTEXT_THIRD	(0x8010)
