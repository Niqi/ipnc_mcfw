...
typedef enum {
	...
	VSYS_OSD_USERTEXT_BMP,
	VSYS_OSD_AUX_USERTEXT_BMP,
	VSYS_OSD_LPRINFO_USERTEXT_BMP
} VSYS_SWOSD_SETBMP;
...
typedef enum
{
	...
	VSYS_SET_LPR_TRIGGER_INFO = 1,   
    VSYS_SET_LPR_TRIGGER_MODE  = 2,
    VSYS_SET_LPR_TRIGGER_INTERVAL  = 3,
    VSYS_SET_LPR_DEFAULT_PROVINCE  = 4,
    VSYS_SET_LPR_PLATE_TYPE  = 5,
    VSYS_SET_LPR_PLATE_WIDTH  = 6,
    VSYS_SET_LPR_MOVING_DIRECTION = 7,
    VSYS_SET_LPR_RECOGNITION_SCHEDULE = 8,
    VSYS_GET_LPR_VERSION = 9
