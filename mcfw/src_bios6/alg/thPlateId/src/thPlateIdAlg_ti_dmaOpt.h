 ...
 *
 */
#ifndef _THPLATEIDALG_TI_DMA_OPT_
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
#define _THPLATEIDALG_TI_DMA_OPT_
...
#define THPLATEIDALG_TI_DMA_setTriggerWord(evt_no, lowTriggerWord, highTriggerWord)\
{\
  if(evt_no < 32)\
  {\
...
#define THPLATEIDALG_TI_DMA_ManualUpdate(paramPtr, addr, value)\
{\
	 addr += value;\
   *(paramPtr) = addr;\
}
...
/** ===========================================================================
*
* @func    THPLATEIDALG_TI_DMA_Fast2D2D()
*
...
*          transfer.
*
* @param   THPLATEIDALG_DMAObj  *dmaHandle
*            -> Pointer to THPLATEIDALG_DMAObj structure.
*
...
Int32 THPLATEIDALG_TI_DMA_Fast2D2D
(
...
/** ===========================================================================
*
* @func    THPLATEIDALG_TI_DMA_Fast2D1D()
*
* @brief   This function does a simple transfer of bytes from source to
...
*
* ===========================================================================*/
Int32 THPLATEIDALG_TI_DMA_Fast2D1D
(
	THPLATEIDALG_DMAObj  *dmaHandle,
...
/** ===========================================================================
*
* @func    THPLATEIDALG_TI_DMA_FastStart()
*
...
*
* ===========================================================================*/
void THPLATEIDALG_TI_DMA_FastStart(THPLATEIDALG_DMAObj *dmaHandle, UInt32 chan_num);

/** ===========================================================================
*
* @func   THPLATEIDALG_TI_DMA_FastWait()
*
...
*
* ===========================================================================*/
void THPLATEIDALG_TI_DMA_FastWait(THPLATEIDALG_DMAObj  *dmaHandle);

/** ===========================================================================
*
* @func    THPLATEIDALG_TI_DMA_MultiStart()
*
* @brief   This function initiates the transfer over a single DMA channel.
*
...
*
* ===========================================================================*/
inline void THPLATEIDALG_TI_DMA_MultiStart(THPLATEIDALG_DMAObj  *dmaHandle, UInt32 lowTriggerWord, UInt32 highTriggerWord)
{
...
#endif /* __cplusplus */
#endif // _THPLATEIDALG_TI_DMA_OPT_
