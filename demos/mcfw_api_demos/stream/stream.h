...
enum {
	...
	/* LPR Parameters */
	STREAM_FEATURE_SET_LPR_RECOGNITION_AREA,
	STREAM_FEATURE_SET_LPR_TRIGGER_INFO,
	STREAM_FEATURE_SET_LPR_TRIGGER_MODE,
	STREAM_FEATURE_SET_LPR_TRIGGER_INTERVAL,
	STREAM_FEATURE_SET_LPR_DEFAULT_PROVINCE,
	STREAM_FEATURE_SET_LPR_PLATE_TYPE,
	STREAM_FEATURE_SET_LPR_PLATE_WIDTH,
	STREAM_FEATURE_SET_LPR_MOVING_DIRECTION,
	STREAM_FEATURE_SET_LPR_RECOGNITION_SCHEDULE,

	STREAM_FEATURE_OSD_USERTEXT,
	STREAM_FEATURE_OSD_USERTEXT_AUX,
	STREAM_FEATURE_OSD_USERTEXT_LPRINFO,
